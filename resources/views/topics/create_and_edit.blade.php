      ...
      <div class="card-body">
        ...
        @endif
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="mb-3">
                    <label for="last_reply_userid-field">Last_reply_userid</label>
                    <input class="form-control" type="text" name="last_reply_userid" id="last_reply_userid-field" value="{{ old('last_reply_userid', $topic->last_reply_userid ) }}" />
                </div> 
                <div class="mb-3">
